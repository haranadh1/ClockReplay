...
/**
 * exception class for memory manager.
 * @author hpoduri
 * @version $Id$
 */
public final class MemoryManagerException extends CRPException {
     ...
     */
    public MemoryManagerException(final String errorCode,
        final String [] args) {
        super(errorCode, args, MemoryManager.zipString());
    }
    /**
    ...
    public String getError() {
        ...
        return MemoryManager.zipString() + ":" + super.getError();
    }
}
