	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('.capture> tbody > tr:odd').css("background-color", "#FCF6CF");
			});
		...
		<script type="text/javascript">
			...
			function getData(_row,sid) {
				...
				document.location.href = "delCapture.jsp?name="+name+"&host=" + host + "&port=" + port;
			}
...
.ui-accordion .ui-accordion-content-active { display: block; }
	...
	<body bgcolor="#FFFAF1">
		<div id="capture_div" style="display:block;border:1px solid #cccccc;margin:17px;text-align:center">
			<h3 align="center">Capture Services</h3>
			<div >
			...
			out.print("<table class=\"capture\" align=\"center\" border=\"1\">");
